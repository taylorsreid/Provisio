...
-- create dummy users
INSERT INTO `users` (user_id, email, user_first_name, user_last_name, hashed_password)
VALUES('f81c3fe5-cc03-11ed-a4d2-1735c641f2fc', 'testuser@example.com', 'Test', 'User', '$2a$10$W9A1VVvL4OoqaTvH3dq6sOdq8D2xQl2NR4nsIrdiX24DhZNc38n7G');
INSERT INTO `users` (user_id, email, user_first_name, user_last_name, hashed_password) 
...
INSERT INTO `reservations` (`reservation_id`, `user_id`, `hotel_id`, `check_in`, `check_out`, `room_size_id`, `wifi`, `breakfast`, `parking`)
VALUES('046be693-9145-4d45-a63d-034ae708725a', 'f81c3fe5-cc03-11ed-a4d2-1735c641f2fc', 1, '2024-04-01', '2024-04-08', 3, 1, 1, 1);
INSERT INTO `reservations` (`reservation_id`, `user_id`, `hotel_id`, `check_in`, `check_out`, `room_size_id`, `wifi`, `breakfast`, `parking`)
VALUES('179dc8db-a8ae-423e-9a74-e42a44900e65', '67583904-cd22-11ed-a4d2-1735c641f2fc', 2, '2024-04-02', '2024-04-08', 1, 1, 1, 0);
INSERT INTO `reservations` (`reservation_id`, `user_id`, `hotel_id`, `check_in`, `check_out`, `room_size_id`, `wifi`, `breakfast`, `parking`)
VALUES('25d3c9b6-f572-4dad-96e2-0b31317759f6', '79657b19-cd22-11ed-a4d2-1735c641f2fc', 3, '2024-04-03', '2024-04-08', 4, 1, 0, 0);

-- create dummy guests, grouped by reservation
INSERT INTO `guests` (guest_id, reservation_id, guest_first_name, guest_last_name)
VALUES(1, '046be693-9145-4d45-a63d-034ae708725a', 'Test', 'User');
INSERT INTO `guests` (guest_id, reservation_id, guest_first_name, guest_last_name)
